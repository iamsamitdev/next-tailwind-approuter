    ...
    <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-gray-800 dark:border-gray-700">
        <nav className="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
            ...
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
                <Link 
                    className={
                        currentPath === "/home" ? "font-medium text-blue-600 sm:py-6 dark:text-blue-500"
                        :
                ...
                <Link  
                    className={
                        currentPath === "/about" ? "font-medium text-blue-600 sm:py-6 dark:text-blue-500"
                        :
                        "font-medium text-gray-500 hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500"
                    } 
                    href="/about">
                ...
                <Link 
                    className={
                        currentPath === "/blog" ? "font-medium text-blue-600 sm:py-6 dark:text-blue-500"
                        :
                        "font-medium text-gray-500 hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500"
                    } 
                    href="/blog">
                ...
                <Link 
                    className={
                        currentPath === "/contact" ? "font-medium text-blue-600 sm:py-6 dark:text-blue-500"
                        :
                        "font-medium text-gray-500 hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500"
                    } 
                    href="/contact">
